...
# TODO: refactor to be in a pydantic config object
max_items_by_floor = [
    (1, 1),
    (4, 2),
]
...
item_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        ...
        (entity_factory.dagger, 5),
        # TODO: remove these two test lines
        (entity_factory.sword, 20),
        (entity_factory.chain_mail, 30),
    ],
    1: [
        (entity_factory.leather_armor, 15),
        # TODO: remove these two test lines
        (entity_factory.sword, 1),
        (entity_factory.chain_mail, 1),
    ],
    2: [
    ...
    4: [
        ...
        (entity_factory.dagger, 1), # decrease
        (entity_factory.leather_armor, 5), # decrease
    ],
    6: [
        (entity_factory.fireball_scroll, 25),
        (entity_factory.confusion_scroll, 5), # decrease
        (entity_factory.chain_mail, 15),
        (entity_factory.leather_armor, 1), # decrease
    ],
}
